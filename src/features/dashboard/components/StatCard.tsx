...
export const StatCard = ({
	...
	return (
		<Card className={`shadow-none border-none rounded-2xl ${styles.bg}`}>
			<Card.Content className="p-6 flex flex-col justify-between min-h-35">
				<div
					className={`flex h-10 w-10 items-center justify-center rounded-full ${styles.iconBg} shadow-sm`}
				>
					<RenderIcon icon={icon} size={20} className={styles.iconColor} />
				</div>
				<div>
